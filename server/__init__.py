...
def create_app():
    ...
    from server.routes.api import db_blueprint
    from server.routes.iex import iex_blueprint

    api_blueprint = Blueprint('api', __name__, url_prefix='/api'
    )
    
    api_blueprint.register_blueprint(iex_blueprint)
    api_blueprint.register_blueprint(db_blueprint)
